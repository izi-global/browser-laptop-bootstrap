...
const Config = function () {
  ...
  this.geoApiKey = getNPMConfig(['electron_google_api_key']) || getNPMConfig(['geo_api_key']) || 'AIzaSyAQfxPJiounkhOjODEO5ZieffeBv6yft2Q'
  this.googleApiKey = getNPMConfig(['google_api_key']) || 'AIzaSyAH90V94EcZBP5oH7oc-mXQrSKgASVxER8'
  this.geoApiEndpoint = getNPMConfig(['electron_google_api_endpoint']) || getNPMConfig(['geo_api_endopoint']) || 'https://www.googleapis.com/geolocation/v1/geolocate?key='
  this.buildProjects()
...
Config.prototype.buildArgs = function () {
  ...
  let args = {
    use_egl: process.platform !== 'darwin',
...
Config.prototype.update = function (options) {
  ...
  if (options.electron_google_api_endpoint) {
    this.geoApiEndpoint = options.electron_google_api_endpoint
  }
